...
if rank == 0:
    for i in range(len(all_C)):
        write_matrix(all_C[i], int(matrix_size // size), matrix_size, "matrix_multiplication_parallel_2n2c_min.txt")
...
if rank == 0:
    for i in range(len(all_C)):
        write_matrix(all_C[i], int(matrix_size // size), matrix_size, "matrix_multiplication_parallel_2n2c.txt")
